    ...
    DevAppServer:
        ...
        Properties:
            ...
            UserData: !Base64 |
                ...
                sudo su
                cd /var/www/html
                aws s3 cp --no-sign-request s3://tomash-aws-masters/content/php/DevApp.php index.php
            Tags:
                - Key: Name
                  Value: "DevApp"
    ...
    PrdAppServer:
        ...
        Properties:
            ...
            UserData: !Base64 |
                ...
                sudo su
                cd /var/www/html
                aws s3 cp --no-sign-request s3://tomash-aws-masters/content/php/PrdApp.php index.php
            Tags:
                - Key: Name
                  Value: "PrdApp"
```
